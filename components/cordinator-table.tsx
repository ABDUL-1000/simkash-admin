...
export default function CordinatorInventoryTable() {
  ...
  const products: Sims[] = [
    ...
    { SimNumber: " 07083175021", network: "MTN", ActiveDate: "Today, 9:12 AM", ExpiryDate: "2nd June, 2026", dataPlan: "Unlimited Yearly" , status: "Active" },
    { SimNumber: "0901XXXX416", network: "Airtel", ActiveDate: "Today, 9:12 AM", ExpiryDate: "2nd June, 2026", dataPlan: "Unlimited Yearly", status: "pending" },
        ...
        <div className="overflow-x-auto">
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                <TableHead className="w-[80px] font-medium">SIM Batch ID</TableHead>
                <TableHead className="font-medium">State Cordinator</TableHead>
