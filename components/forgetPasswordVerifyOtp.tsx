    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden w-1/2 md:flex relative flex-col items-center justify-center bg-white p-4">
        ...
        <div className="w-[60%] flex flex-col items-center text-center">
          ...
          />
          <h2 className="mt-6 text-2xl font-semibold text-slate-800">Reset Your Password</h2>
          <p className="mt-2 text-gray-600">Enter the verification code to reset your password</p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex flex-col relative bg-gray-100 p-6">
        ...
        <div className="absolute top-4 hidden lg:block right-10 text-sm text-black">
          <Link href="/forgetpassword" className="flex items-center gap-2 hover:underline">
        ...
        <div className="flex items-center lg:hidden justify-between">
          ...
          <Link href="/forgetpassword" className="flex items-center gap-1 hover:underline">
            <ArrowLeft className="w-4 h-4" />
            Back
          </Link>
        </div>
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6">
            ...
            {countdown === 0 && (
              <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-yellow-700 text-sm">OTP has expired. Please request a new one.</p>
              </div>
            )}
