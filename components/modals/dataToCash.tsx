...
const dataToCashSchema = z.object({
...
type DataToCashForm = z.infer<typeof dataToCashSchema>

const DataToCashModal: React.FC<DataToCashModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  // Conversion rates (different rates for data)
  ...
  const calculateCashValue = () => {
    ...
    const rate = conversionRates[network] || 0.7
    return amount * rate
  }
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-1">
          {step === 1 && (
            <>
              ...
              <div className="space-y-3">
                ...
                <Input
                  placeholder="Enter SIM number with data"
          ...
          {step === 3 && (
            <>
              ...
              {/* Amount Input */}
              <div className="space-y-4">
                <label className="text-sm font-medium text-gray-700">Enter Data Amount (MB)</label>
                <div className="relative">
                  <Input
                    type="number"
                    placeholder="Enter data amount in MB"
                    className="p-3 border-gray-300 bg-white"
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">
                      {(conversionRates[watchedValues.network as keyof typeof conversionRates] || 0.7) * 100}% of value
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white rounded-lg border border-gray-200 space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{watchedValues.amount} MB</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Conversion Rate:</span>
                    <span className="font-medium">
                      {(conversionRates[watchedValues.network as keyof typeof conversionRates] || 0.7) * 100}%
                    </span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-700">
                  <p>
                    <strong>Note:</strong> This will convert your data to cash. The data will be deducted from your SIM
                    card.
                  </p>
                </div>
              </div>
          ...
          {step === 6 && (
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Your data has been converted to cash successfully.</p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 space-y-2 text-sm border border-gray-200">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{watchedValues.amount} MB</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="mt-8">
          {step === 1 ? (
            ...
            >
              {isProcessing ? "Processing..." : "Convert Data to Cash"}
            </Button>
          ) : (
            <Button
              onClick={onReset}
...
export default DataToCashModal
