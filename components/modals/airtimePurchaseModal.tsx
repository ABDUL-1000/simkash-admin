...
const airtimeSchema = z.object({
  ...
  amount: z.number().min(50, "Minimum amount is ₦50").max(10000, "Maximum amount is ₦10,000"),
...
const AirtimeModal: React.FC<AirtimeModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const {
    ...
    resolver: step === 4 ? zodResolver(airtimeSchema) : undefined, // Only validate on PIN step
    defaultValues: {
      phoneNumber: "",
      network: "",
      amount: 0,
  ...
  const onNext = () => {
    ...
    if (step === 2) {
      if (!watchedValues.amount || watchedValues.amount < 50) {
        return
      }
      setStep(3)
      return
        ...
        <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-1">
          ...
          {step === 2 && (
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3 max-h-[200px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                    ...
                    <button
                      ...
                      className={`p-3 text-center border rounded-lg transition-colors ${
                        watchedValues.amount === amount
                          ? "border-[#24C0FF] bg-blue-50 text-[#24C0FF]"
          ...
          {step === 5 && (
            <div className="text-center space-y-4">
              ...
              <div>
                <p className="text-green-600 text-lg font-bold">Airtime Purchase Successful!</p>
                <p className="text-gray-600">Your airtime has been recharged successfully.</p>
              </div>
        ...
        <div className="mt-8">
          {step === 1 ? (
            ...
            <Button
              onClick={onNext}
              className="w-full bg-[#24C0FF] hover:bg-[#1BA8E6] text-white py-3 rounded-lg font-medium"
              disabled={!watchedValues.amount || watchedValues.amount < 50}
            >
              Continue
            </Button>
          ) : step === 3 ? (
