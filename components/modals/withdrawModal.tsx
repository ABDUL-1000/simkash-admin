...
const WithdrawModal: React.FC<SendMoneyModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
          ...
          <div className=" ">
            ...
            <div className="flex justify-center mt-4 mb-6">
              <div className="flex items-center gap-2">
                <div
                  className={`w-6 h-1 ${
                    step >= 1 ? "bg-[#24C0FF]" : "bg-gray-300"
                  }`}
                />
                <div
                  className={`w-6 h-1 ${
                    step >= 2 ? "bg-[#24C0FF]" : "bg-gray-300"
                  }`}
                />
                <div
                  className={`w-6 h-1 ${
                    step >= 3 ? "bg-[#24C0FF]" : "bg-gray-300"
                  }`}
                />
                <div
                  className={`w-6 h-1 ${
                    step >= 4 ? "bg-[#24C0FF]" : "bg-gray-300"
                  }`}
                />
                <div
                  className={`w-6 h-1 ${
                    step >= 5 ? "bg-[#24C0FF]" : "bg-gray-300"
                  }`}
                />
              </div>
            </div>
        ...
        <div className="space-y-4">
            ...
            <>
              ...
              <div className="space-y-2">
                <select
                  ...
                  className="w-full h-10 border border-gray-300 rounded-md px-3 focus:border-cyan-400 focus:ring-cyan-400"
                >
              ...
              <div className="p-3 bg-gray-50 border rounded-md min-h-[40px] flex items-center">
                {isVerifying ? (
          ...
          {step === 3 && (
            <>
              {/* Transfer Summary */}
              <div className="space-y-4">
                <div className="p-4 bg-[#EEF9FF] rounded-lg space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {
                        banks.find((b) => b.value === watchedValues.bankName)
                          ?.label
                      }
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-lg">
                      ₦{Number(watchedValues.amount || 0).toLocaleString()}
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex bg-[#EEF9FF] items-center justify-between">
          ...
          {step === 4 && (
            <>
              ...
              <div className="p-3 bg-[#EEF9FF] rounded-lg">
        ...
        <div className="mt-6">
          {step < 5 ? (
            <Button
              ...
              disabled={step === 1 && (!accountName || isVerifying)}
            >
              {step === 3 ? "Confirm" : step === 4 ? "Send Money" : "Continue"}
            </Button>
          ) : (
            <Button
              onClick={onReset}
