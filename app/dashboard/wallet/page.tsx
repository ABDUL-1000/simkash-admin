          ...
          <CardContent>
            <div className="flex flex-col  lg:flex-row w-full gap-4">
              ...
              <div className="w-full lg:w-1/2 flex flex-col gap-4">
                {/* Top row - Send and Withdraw */}
                <div className="flex gap-4">
                  {quickActions.slice(0, 2).map((action, index) => (
                    <button
                      key={index}
                      onClick={action.onClick}
                      className="flex-1 p-6 bg-white rounded-lg flex flex-col items-center justify-center hover:bg-gray-50 transition-colors"
                    >
                      <Image
                        src={action.icon}
                        alt={action.label}
                ...
                {/* Bottom row - Top Up (full width) */}
                <button
                  onClick={() => setOpenModal("topup")}
                  className="p-6 bg-white rounded-lg flex flex-col items-center justify-center hover:bg-gray-50 transition-colors"
                >
                  <Image
                    src="/Vector1.png"
                    alt="Top Up"
